...
function Trusted() {
  const logos: Logo[] = [
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=Really+Good", alt: "Really Good" },
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=ADJUST", alt: "Adjust" },
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=W", alt: "W" }, // This could be Weebly or Wordpress
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=BEAR+HUG%0AENTERTAINMENT", alt: "Bear Hug Entertainment" },
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=FUNDER", alt: "Funder" },
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=PE%0A0-2", alt: "PE 0-2" },
    ...
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=Unilever", alt: "Unilever" },
    { src: "https://placehold.co/160x80/31309E/FFFFFF?text=GAUDIO", alt: "Gaudio" },
  ];
  ...
  // This includes the logo image itself plus internal padding, and external margin.
  // We'll set the container width (itemWidth) and apply padding within the item.
  ...
  useEffect(() => {
    ...
    const startAutoScroll = (): void => {
      ...
      animation = animate(x1, -scrollDistance, { // Animate x1 to negative for left-to-right
        ease: "linear",
  ...
  useEffect(() => {
    ...
    const startAutoScroll = (): void => {
      ...
      animation = animate(x2, -scrollDistance, { // Animate x2 to positive for right-to-left appearance
        ease: "linear",
  ...
  return (
    <div className="bg-blue-500 py-16 overflow-hidden"> {/* Main container background color */}
      <h2 className="text-white text-center text-3xl font-bold mb-10">Trusted by</h2>
        ...
        >
          {duplicatedLogos.map((logo: Logo, index: number) => (
            <div
              ...
              style={{ width: itemWidth, height: itemHeight, minWidth: itemWidth }} // Enforce width and height
            >
