...
const categories = ['All', 'Fintech', 'Ecommerce', 'Gaming', 'SaaS', 'Mobile', 'B2B'];
...
const resultsData = [
  // Full dataset to simulate infinite scroll
  {
    ...
    imageUrl: 'https://www.wheelchairbasketball.ca/wp-content/uploads/2024/10/20240831_WHEELCHAIR_BASKETBALL_CPC7808AB-1400x600-1.png',
  },
  {
    id: '2',
    category: 'Motion',
...
export default function App() {
  ...
  // Removed showPreviewModal and previewImageUrl states
  ...
  return (
    <div className="bg-black min-h-screen px-4 md:px-10 py-25 text-white font-inter"> 
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-gray-400 mb-6">Case studies which go a little deeper on the results we've achieved for a few of our clients</p>
          ...
          {categories.map((cat) => (
            <button
              ...
              className={`capitalize px-4 py-2 rounded-full border border-gray-700 text-sm font-medium transition-colors duration-200
                ${selectedCategory === cat ? 'bg-blue-600 text-white' : 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white'}`}
              onClick={() => {
                  ...
                  {hoveredItemId === item.id && (
                    ...
                    >
                      ...
                      <Link href='/details'
                        ...
                        style={{ backgroundColor: '#0dcaf0', color: 'black', borderColor: '#0dcaf0' }} 
                      >
                        View
                      </Link>
                    </motion.div>
        ...
        <div ref={loadMoreRef} className="h-10 mt-10 text-center text-gray-400">
          {visibleItems.length < filteredResults.length ? 'Loading more results...' : 'No more results to show.'}
        </div>
      </div>
