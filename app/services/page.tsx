...
const App: React.FC = () => {
  ...
  const services = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M12 20.005H.995V10.995h22V20.005H12zm0 0v-8.203" />
        </svg>
      ),
    },
    {
      ...
      category: 'grow',
      title: 'PPC',
      description: 'Get access to top PPC talent and the latest paid search strategies to boost growth, increase sales and outmaneuver competitors.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM12 14c-1.463 0-2.873.267-4.159.753c-.663.243-1.309.526-1.928.847C2.79 16.514 2 17.555 2 18.736V21h20v-2.264c0-1.18-.79-2.221-1.992-2.894a8.125 8.125 0 00-1.928-.847A15.938 15.938 0 0012 14z" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      description: 'Work with our world-class team of conversion rate optimisation experts to ensure you yield the greatest value possible from paid and organic...',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      category: 'optimise',
      title: 'Landing Pages',
      description: 'Test your campaign conversion rates to the next level with our bespoke landing pages optimised by our leading data driven experimentation.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-1.75-3M3 13h18M5 17h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
        </svg>
      ),
    },
    {
      ...
      description: 'Crafting responsive and high-performance websites tailored to your business needs. From concept to launch, we build digital experiences that convert.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4" />
        </svg>
    ...
    },
    {
      ...
      description: 'Designing intuitive and engaging mobile applications for iOS and Android. We focus on user experience and modern aesthetics to make your app stand out.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      description: 'Producing high-quality, engaging content including articles, blogs, videos, and infographics to captivate your audience and boost your SEO.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    },
    {
      ...
      description: 'Developing a strong and memorable brand identity that resonates with your target audience. This includes logo design, brand guidelines, and visual assets.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  */
  ...
  const filteredServices = services.filter(service => { // Change 'services' to 'backendServices' if using backend data
  ...
  const optimiseServices = filteredServices.filter(s => s.category === 'optimise');
  const createServices = filteredServices.filter(s => s.category === 'create');
  ...
  return (
    <div className="min-h-screen bg-black px-8 py-15 text-white font-inter">
      ...
      <main className="pt-8 pb-16 px-4 sm:px-8 lg:px-16"> {/* Adjusted padding-top */}
        {/* Hero Section */}
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
          <div className="text-left mb-12">
            <h2 className="lg:text-8xl md:text-5xl font-bold mb-4">Our Services</h2>
            <p className="lg:text-2xl md:text-lg text-white max-w-2xl mx-auto">Spin up a complete growth marketing department on-demand or extend your existing team with the specific service packages you need.</p>
          </div>
        ...
        <div className="py-4 px-6 flex flex-col sm:flex-row items-center justify-between mb-12 bg-transparent rounded-lg">
          <div className="relative w-full sm:w-1/3 mb-4 sm:mb-0">
            ...
            />
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 absolute left-3 top-1/2 transform -translate-y-1/2 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
          </div>
          <nav className="flex border border-blue-600 rounded-full p-1  space-x-4">
            <button
              className={`px-6 py-2 text-2xl rounded-full transition-colors cursor-pointer duration-300 ${activeFilter === 'grow' ? 'bg-blue-600' : 'bg-gray-800 hover:bg-blue-600'}`}
              onClick={() => handleFilterClick('grow')}
            >
              Grow
            </button>
            <button
              className={`px-6 py-2 text-2xl rounded-full transition-colors cursor-pointer duration-300 ${activeFilter === 'optimise' ? 'bg-blue-600' : 'bg-gray-800 hover:bg-blue-600'}`}
              onClick={() => handleFilterClick('optimise')}
            >
              Optimise
            </button>
            <button
              className={`px-6 py-2 text-2xl  rounded-full transition-colors cursor-pointer duration-300 ${activeFilter === 'create' ? 'bg-blue-600' : 'bg-gray-800 hover:bg-blue-600'}`}
        ...
        {/* Grow Section */}
        {(growServices.length > 0 || activeFilter === 'grow' || searchTerm === '') && (
        ...
        {/* Optimise Section */}
        {(optimiseServices.length > 0 || activeFilter === 'optimise' || searchTerm === '') && (
          <section ref={optimiseRef} className="mb-20">
            <h2 className="text-5xl font-bold mb-8 text-white">Optimise</h2>
            <p className="text-gray-400 mb-12 max-w-2xl">
              Increase the number of visitors to your app, website and landing pages that become valuable customers or users.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {/* Create Section */}
        {(createServices.length > 0 || activeFilter === 'create' || searchTerm === '') && (
          <section ref={createRef} className="mb-20">
            <h2 className="text-5xl font-bold mb-8 text-white">Create</h2>
            <p className="text-gray-400 mb-12 max-w-2xl">
              Bring your ideas to life with our expert design and development services. We build innovative solutions that stand out.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
